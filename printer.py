...
def print_label(kerberos, date):
    ...
    font_light = ImageFont.truetype('Roboto-Regular.ttf', 46)
    font_italic = ImageFont.truetype('Roboto-Regular.ttf', 36)
    ...
    draw.text((30, 160), date.strftime("%I:%M %p").lower(), font=font_italic, fill=(0, 0, 0))
